...
2. Create a transparent Canvas View over a ImageView. After markup get the markup drawing image from Canvas View and draw it over our selected Image for desired output.

On comparing both the approaches we found that second approach is more suitable to solve our problem.
 ...
 * It's challenging to customise the tool picker.
